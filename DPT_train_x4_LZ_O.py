...
from model.DPT_modified import Net
...
# --------------------------------------------------------------------------#
# Training settings
parser = argparse.ArgumentParser(description="PyTorch LFSSR-LFDPT training")
...
def main():
    ...
    opt.record = True
    opt.dataroot = "/data/zy/realLFSR/dataset/LytroZoom_O_x2"
    opt.test_patch = [1, 1]

    opt.trainFile = "/data/zy/realLFSR/dataset/LytroZoom_O_x2/train_out.txt"
    opt.testFile = "/data/zy/realLFSR/dataset/LytroZoom_O_x2/test_out.txt"
    opt.pretrain =  '/data/zy/realLFSR/LytroZoom_P_modelpth/DPT_x2_LZ_P.pth'
    # --------------------------------------------------------------------------#
    ...
    opt.save_prefix = 'DPT_LytroZoomO_x{}'.format(opt.scale)
    ...
    #         if 'tar' in opt.pretrain:
    #             print('The model comes from the official code!')
    #             model = load_state_dict_to_model(model, ckpt['state_dict'])
    #         else:
    #             print('The model comes from our training!')
    #             model = load_state_dict_to_model(model, ckpt['model'])
    #     else:
    #         print('===> no model found at {}'.format(opt.pretrain))
    # else:
