...
from model.LF_InterNet_modified import Net
...
def main():
    ...
    opt.record = True
    opt.dataroot = "/data/zy/realLFSR/dataset/LytroZoom_O_x4"
    opt.test_patch = [1, 1]

    opt.trainFile = "/data/zy/realLFSR/dataset/LytroZoom_O_x4/train_out.txt"
    opt.testFile = "/data/zy/realLFSR/dataset/LytroZoom_O_x4/test_out.txt"
    opt.pretrain =  '/data/zy/realLFSR/LytroZoom_P_modelpth/InterNet_x4_LZ_P.pth'
    # --------------------------------------------------------------------------#
    ...
    opt.save_prefix = 'InterNet_LytroZoomO_x{}'.format(opt.scale)
