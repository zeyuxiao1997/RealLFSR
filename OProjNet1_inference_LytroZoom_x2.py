...
parser.add_argument("--model_dir", type=str,default="/data/zy/realLFSR/result/checkpoints/OProjNet_x2_LZ_P.pth",help="model dir")
...
def test():
    model.eval()
    save_dir = '/data/zy/realLFSR/code_inference/result_final/OProjNet_LytroZoom_x2/'
