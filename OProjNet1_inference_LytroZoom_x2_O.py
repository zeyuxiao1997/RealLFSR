...
parser.add_argument("--model_dir", type=str,default="/data/zy/realLFSR/result/checkpoints/OProjNet_x2_LZ_O.pth",help="model dir")
...
class DatasetFromHdf5List_test(data.Dataset):
    def __init__(self, dataroot, list_path, scale):
        ...
        for h5file in self.h5files:
            ...
            img_LR_2 = hf.get('x2_ycbcr')  # [N,ah,aw,h/2,w/2]
...
def test():
    model.eval()
    save_dir = '/data/zy/realLFSR/code_inference/result_final_workshop/OProjNet_LytroZoom_x2/'
