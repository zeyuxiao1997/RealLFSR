...
parser.add_argument("--model_dir", type=str,default="/data/zy/realLFSR/result/checkpoints/OProjNet_x4_LZ_O.pth",help="model dir")
...
def test():
    model.eval()
    save_dir = '/data/zy/realLFSR/code_inference/result_final_workshop/OProjNet_LytroZoom_x4/'
