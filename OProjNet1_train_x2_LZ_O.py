...
# 1700, Mean PSNR: 29.98871690338731
def main():
    global opt, model
    opt = parser.parse_args()

    opt.record = True
    opt.dataroot = "/home/ustc/Code/xiaozy/realLFSR/data/LytroZoom_O_x2"
    opt.test_patch = [1, 1]

    opt.trainFile = "/home/ustc/Code/xiaozy/realLFSR/data/LytroZoom_O_x2/train_out.txt"
    opt.testFile = "/home/ustc/Code/xiaozy/realLFSR/data/LytroZoom_O_x2/test_out.txt"
    opt.pretrain =  '/home/ustc/Code/xiaozy/realLFSR/LytroZoom_P_modelpth/OProjNet_x2_LZ_P.pth'
