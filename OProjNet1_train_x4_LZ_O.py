...
from dataset.datasetx4 import DatasetFromHdf5List_train, DatasetFromHdf5List_test
...
parser.add_argument("--patch_size", type=int, default=72, help="Training patch size")
parser.add_argument("--batch_size", type=int, default=4, help="Training batch size")
parser.add_argument("--resume_path", type=str, default="", help="resume from checkpoint path")
parser.add_argument("--num_cp", type=int, default=20, help="Number of epoches for saving checkpoint")
...
parser.add_argument("--save_dir", type=str, default="/home/ustc/Code/xiaozy/realLFSR/result/")
...
# Testing epoch: 3200, Mean PSNR: 28.09096927112669
def main():
    global opt, model
    opt = parser.parse_args()

    opt.record = True
    opt.dataroot = "/home/ustc/Code/xiaozy/realLFSR/data/LytroZoom_O_x4"
    opt.test_patch = [1, 1]

    opt.trainFile = "/home/ustc/Code/xiaozy/realLFSR/data/LytroZoom_O_x4/train_out.txt"
    opt.testFile = "/home/ustc/Code/xiaozy/realLFSR/data/LytroZoom_O_x4/test_out.txt"
    opt.pretrain =  '/home/ustc/Code/xiaozy/realLFSR/LytroZoom_P_modelpth/OProjNet_x4_LZ_P.pth'
    # --------------------------------------------------------------------------#
    ...
    opt.save_prefix = 'OProjNet1_LytroZoom_O_x{}_FT'.format(opt.scale)
