...
parser.add_argument("--step", type=int, default=3000, help="Learning rate decay every n epochs")
...
def main():
    ...
    opt.trainFile = "/data/zy/realLFSR/dataset/small_x4_xiao/train.txt"
    ...
    opt.save_prefix = 'OProjNet1_x{}'.format(opt.scale)
