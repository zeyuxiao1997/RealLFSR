...
class DatasetFromHdf5List_train(data.Dataset):
    def __init__(self, dataroot, list_path, scale, patch_size):
        ...
        for h5file in self.h5files:
            ...
            img_LR_2 = hf.get('x2_ycbcr')[:,:,0,:,:]  # [N,ah,aw,h/2,w/2]
    ...
    def __getitem__(self, index):
        ...
        lr_2 = np.array(self.img_LR_2s)[file_index]  # [ah,aw,h/2,w/2]
        ...
        lr_2 = lr_2[:, :, x:x + self.psize, y:y + self.psize]  # [ah,aw,ph/2,pw/2]
        ...
        lr_2 = lr_2.reshape(-1, self.psize, self.psize)  # [an,phs,pws]
