...
class Net(nn.Module):
    def __init__(self, opt):
        ...
        self.fea_conv0 = nn.Sequential(
            DownBlock(self.scale),
            nn.Conv2d(self.scale**2, channels, 3, 1, 1, bias=True)
            )
    ...
    def forward(self, lf_lr):
        ...
        for i in range(self.an2):
            ...
            infea = lf_pair_fea.view(B * an2, -1, h, w)
            lf_pair_fea = self.relu(self.pair_conv0(infea))
