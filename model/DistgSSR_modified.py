...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.init_conv = nn.Sequential(
            ...
            nn.Conv2d(self.factor**2, channels, kernel_size=3, stride=1, dilation=self.angRes, padding=self.angRes, bias=False)
            )
    ...
    def forward(self, x, info=None):
        ...
        # print(x.shape)
        # x_upscale = F.interpolate(x, scale=self.factor, mode='bilinear', align_corners=False)
